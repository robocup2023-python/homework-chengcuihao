...
#include "image_msg/msg/detail/camera_image__rosidl_typesupport_fastrtps_c.h"
...
#include "image_msg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _CameraImage__ros_msg_type = image_msg__msg__CameraImage;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_image_msg
size_t get_serialized_size_image_msg__msg__CameraImage(
  const void * untyped_ros_message,
...
static uint32_t _CameraImage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_image_msg__msg__CameraImage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_image_msg
size_t max_serialized_size_image_msg__msg__CameraImage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = image_msg__msg__CameraImage;
    is_plain =
      (
...
static size_t _CameraImage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_image_msg__msg__CameraImage(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, image_msg, msg, CameraImage)() {
