...
bool image_msg__msg__camera_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("image_msg.msg._camera_image.CameraImage", full_classname_dest, 39) == 0);
  }
  image_msg__msg__CameraImage * ros_message = _ros_message;
  {  // data
  ...
  {  // channel
    ...
    assert(PyLong_Check(field));
    ros_message->channel = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // fps
...
PyObject * image_msg__msg__camera_image__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("image_msg.msg._camera_image");
